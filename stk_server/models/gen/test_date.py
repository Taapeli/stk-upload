...
from models.gen.dates import DR, DateRange
...
class TestDateRange(unittest.TestCase):
    ...
    def testTwoDateInit(self):
        d1 = "1918-12"
        d2 = date(2017, 10, 16)
        dr1 = DateRange(DR['BETWEEN'], d1, d2)
        got = dr1.to_tuple()
        ...
        dr3 = DateRange(DR['TILL'], 737034)
        self.assertEqual(dr3.to_tuple(), (1, '2018-12-06', ''), msg="short tuple")

        dr3 = DateRange(DR['BETWEEN'], d1, d2)
