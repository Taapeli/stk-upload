...
RESEARCHER_OPERATIONS = { #    browse     request   withdraw  download log     details  delete
    State.ROOT_UNKNOWN:        (False,    False,    False,    False,   True,   True,    True),
    State.FILE_LOADING:        (False,    False,    False,    False,   True,   True,    True),
    ...
    State.ROOT_AUDITING:       (True,     False,    False,    True,    True,   True,    True),
