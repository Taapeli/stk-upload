...
@bp.route('/narrative/person/list/', methods=['POST', 'GET'])
...
@bp.route('/person/list/restricted')
...
@bp.route('/person/list_all/<string:opt>')
@bp.route('/person/list_all/')
#     @login_required
...
@bp.route('/events/source=<sourceid>')
