...
class MediaReader(DataService):
    ...
    def read_my_media_list(self):
        ...
        res = shareds.dservice.dr_get_media_list(self.use_user, self.user_context.batch_id, fw, limit)
    ...
    def get_one(self, oid):
        ...
        user = self.user_context.batch_user()
        res = shareds.dservice.dr_get_media_single(user, self.user_context.batch_id, oid)
